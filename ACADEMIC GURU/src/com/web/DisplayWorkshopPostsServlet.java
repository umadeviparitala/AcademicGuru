...
@WebServlet("/DisplayWorkshopPostsServlet")
public class DisplayWorkshopPostsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		postsList = userPostsDAO.getWorkshopPosts(); //so it can accept any child class returned like array list,vector, linked list.

		if(!postsList.isEmpty()) {
			System.out.println("Exists");
			request.setAttribute("postsList", postsList);
			RequestDispatcher requestDispatcher = request.getRequestDispatcher("DisplayWorkshopPosts.jsp");
